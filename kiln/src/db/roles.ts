...
export const DB_ROLE_BY_APP_ROLE = {
  owner: 'kiln_role_owner',
  account_manager: 'kiln_role_manager',
  member: 'kiln_role_member',
  partner: 'kiln_role_partner',
} as const satisfies Record<AppRole, string>;

export type DbRole = (typeof DB_ROLE_BY_APP_ROLE)[AppRole];

/** Roles the migration creates. `kiln_app` connects; the rest are switched into. */
