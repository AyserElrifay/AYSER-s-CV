  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="mt-1.5 block w-full rounded-[8px] border border-line bg-surface px-3 py-2 text-[15px] text-ink placeholder:text-ink-faint aria-[invalid]:border-critical"
      />
