...
-- security-definer helper — bypasses RLS internally so this policy
-- doesn't query dm_participants THROUGH dm_participants' own policy
-- (that self-reference causes "infinite recursion detected in policy
-- for relation dm_participants").
