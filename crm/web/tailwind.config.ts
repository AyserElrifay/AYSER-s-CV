...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      colors: {
        // Notion-like warm neutrals, driven by CSS variables in globals.css
        ...
        // Calm stage colors for the pipeline
        stage: {
      ...
      boxShadow: {
        ...
        pop: "0 4px 16px rgba(15, 15, 15, 0.08), 0 1px 3px rgba(15, 15, 15, 0.05)",
      },
      keyframes: {
        "fade-in": {
