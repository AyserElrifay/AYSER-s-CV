...
export const PersonPin = ({ p, onPress }) => (
  <Pressable onPress={onPress} style={{ alignItems: 'center' }}>
    <View style={{ backgroundColor: C.float, borderColor: C.line, borderWidth: 1, borderRadius: 12, paddingHorizontal: 8, paddingVertical: 4, marginBottom: 5 }}>
...
export const CampfirePin = ({ c }) => {
  ...
  return (
    <View style={{ alignItems: 'center' }}>
      ...
      <View style={{ backgroundColor: C.float, borderColor: 'rgba(244,63,94,0.5)', borderWidth: 1, borderRadius: 10, paddingHorizontal: 7, paddingVertical: 2, marginTop: 2 }}>
