...
export const DESTINATIONS = [
  ...
  { id: 'cn_greatwall', hero: true, country: 'China', flag: '🇨🇳', emoji: '🧱', name: 'The Great Wall at Mutianyu', area: 'Beijing',
    lat: 40.4319, lng: 116.5704, tags: ['Heritage', 'Hiking'],
    desc: 'The restored stretch north-east of Beijing, steep and far quieter than Badaling. A cable car up and, if you want it, a toboggan down.' },
  { id: 'cn_forbidden', country: 'China', flag: '🇨🇳', emoji: '🏯', name: 'The Forbidden City', area: 'Beijing',
    lat: 39.9163, lng: 116.3972, tags: ['Heritage', 'Culture'],
    desc: 'Nine thousand rooms behind a moat, the seat of twenty-four emperors over five centuries. Tickets are timed and sell out days ahead.' },
  { id: 'cn_terracotta', country: 'China', flag: '🇨🇳', emoji: '🗿', name: 'The Terracotta Army', area: "Xi'an",
    lat: 34.3841, lng: 109.2785, tags: ['Heritage', 'Culture'],
    desc: 'Eight thousand soldiers buried to guard a tomb, found by farmers digging a well in 1974. No two faces are the same.' },
  { id: 'cn_bund', country: 'China', flag: '🇨🇳', emoji: '🌆', name: 'The Bund', area: 'Shanghai',
    lat: 31.2397, lng: 121.4900, tags: ['Culture', 'Photo'],
    desc: 'A mile of 1920s riverfront on one bank and the whole modern skyline on the other. Walk it at dusk, when both sides are lit.' },
  { id: 'cn_liriver', country: 'China', flag: '🇨🇳', emoji: '⛰️', name: 'The Li River', area: 'Yangshuo',
    lat: 24.7784, lng: 110.4969, tags: ['Nature', 'Photo'],
    desc: 'The limestone peaks on the back of the twenty-yuan note. Take the bamboo raft between Yangdi and Xingping rather than the big boat.' },
  { id: 'cn_westlake', country: 'China', flag: '🇨🇳', emoji: '🌿', name: 'West Lake', area: 'Hangzhou',
    lat: 30.2489, lng: 120.1416, tags: ['Nature', 'Culture'],
    desc: 'Causeways, willows and tea hills, painted and written about for a thousand years. Walk the far side, where almost nobody goes.' },
];
