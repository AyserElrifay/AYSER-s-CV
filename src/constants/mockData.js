...
export const PLAY_GAMES = [
  { id: 'run1', nameKey: 'game_runner', playersKey: 'players_2_4', name: 'Catch Your Mate', emoji: '🏃', tag: 'Run together', players: '2–4 mates', desc: 'Chase your friend through the streets and dodge everything in your path. Crash and you’re out — last one running wins the round.', kind: 'runner' },
  { id: 'run2', nameKey: 'game_rooftop', playersKey: 'players_1_or_race', name: 'Rooftop Rush', emoji: '🏙️', tag: 'A story in 4 chapters', players: '1 player · or race a mate', desc: 'Run the Cairo rooftops at sunset, slide the Alpine ice, cross Paris by night and finish in the Carpathians — four chapters, four chasers, a challenge to clear in each. Tap to jump, twice to double-jump, hold to slide.', kind: 'rooftop' },
  { id: 'rps', nameKey: 'game_rps', playersKey: 'players_1_or_call', name: 'Rock Paper Scissors', emoji: '✊', tag: 'One hand · quick', players: '1 player · or a mate in a call', desc: 'Rock, paper, scissors. The other hand is picked before you tap and only shown after, so it can never read you. Keep a run going — your streak goes on the real global leaderboard.', kind: 'rps' },
  { id: 'stack', nameKey: 'game_stack', playersKey: 'players_1', name: 'Stack', emoji: '🧱', tag: 'Solo · beat your best', players: '1 player', desc: 'Tap to drop each block dead-centre and build the tallest tower you can. One sloppy drop and it all comes down. Chase the perfect streak.', kind: 'stack' },
  { id: 'tower', nameKey: 'game_tower', playersKey: 'players_1', name: 'The Climb', emoji: '🧗', tag: 'Six wonders · six towers', players: '1 player', desc: 'Climb the inside of the Great Pyramid, Petra, a Marrakech minaret, a Roman amphitheatre, a marble dome and a Kyoto pagoda — with the weather rising underneath you. Hold your thumb where you want to go; he bounces the moment he lands, and speed is what makes a big bounce. Clear the place and you keep its culture card.', kind: 'tower' },
  { id: 'hop', nameKey: 'game_hop', playersKey: 'players_1', name: 'The Crossing', emoji: '🚦', tag: 'Six cities · one street each', players: '1 player', desc: 'Cairo taxis and tuk-tuks, a Marrakech calèche, the trams of Kyoto — and a river you can only cross on a boat that will not wait. Tap to hop forward, swipe to go sideways. Reach the monument on the far side and the city gives you its card.', kind: 'hop' },
  { id: 'tod', nameKey: 'game_tod', playersKey: 'players_2plus', name: 'Truth or Dare', emoji: '🎲', tag: 'In chat', players: '2+ mates', desc: 'Drop it into any chat — a mate one-on-one or the whole gang. Spin, dare, laugh, remove it anytime.', kind: 'chat' },
];
