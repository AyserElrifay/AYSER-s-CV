...
export const DB_ROLE_BY_APP_ROLE = {
  owner: 'qirat_role_owner',
  account_manager: 'qirat_role_manager',
  member: 'qirat_role_member',
  partner: 'qirat_role_partner',
} as const satisfies Record<AppRole, string>;

export type DbRole = (typeof DB_ROLE_BY_APP_ROLE)[AppRole];

/** Roles the migration creates. `qirat_app` connects; the rest are switched into. */
