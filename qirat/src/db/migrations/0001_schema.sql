...
create schema if not exists qirat;
...
create or replace function qirat.current_org_id() returns uuid
  language sql stable
  set search_path = pg_catalog, public
as $$ select nullif(current_setting('app.org_id', true), '')::uuid $$;

create or replace function qirat.current_user_id() returns uuid
  language sql stable
  set search_path = pg_catalog, public
